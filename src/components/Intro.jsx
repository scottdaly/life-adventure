      ...
      <div className=" max-w-2xl mx-auto flex flex-col gap-1">
        ...
        <div className="flex flex-col mt-4 mb-4">
          <div className="flex flex-col lg:flex-row justify-between gap-4">
            <div className="flex flex-col">
              <p className="text-lg text-zinc-400">Born in</p>
            ...
            <div className="flex flex-col lg:text-right mb-4">
              <div className="flex flex-col gap-1 items-start justify-start lg:justify-end lg:items-end">
                <p className=" text-zinc-400">Appearance</p>
          ...
          <p className="ibm-plex-mono-regular mt-3 mb-4 text-zinc-200">
          ...
          <div className="flex flex-col gap-2 mt-8">
            ...
            <div className="flex justify-between">
              <p className="text-sm text-bold text-zinc-400">Intelligence</p>
